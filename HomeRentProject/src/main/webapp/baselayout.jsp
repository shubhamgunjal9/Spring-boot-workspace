...
<div id="mainContainer">
   <!-- <div style="width:auto;top:10px; height: auto;"> -->
	...
	<!-- <div class="container" style=" width: 100%;margin-top: 15px;float: left; "> -->	
	<div class="container"  style="padding-left:5px;padding-top:50px;padding-right:5px;padding-bottom:30px;height: auto;">
